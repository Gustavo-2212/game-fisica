...
public class Fase5Pergunta6 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase5Pergunta6 frame = new Fase5Pergunta6(pont);
	...
	public Fase5Pergunta6(Pontuacao p) {
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(6, 5);
	}
