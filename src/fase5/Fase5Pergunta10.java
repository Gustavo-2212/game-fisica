...
public class Fase5Pergunta10 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase5Pergunta10 frame = new Fase5Pergunta10(pont);
	...
	public Fase5Pergunta10(Pontuacao p) {
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(10, 5);
	}
