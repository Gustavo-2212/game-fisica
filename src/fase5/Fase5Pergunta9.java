...
public class Fase5Pergunta9 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase5Pergunta9 frame = new Fase5Pergunta9(pont);
	...
	public Fase5Pergunta9(Pontuacao p) {
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(9, 5);
	}
