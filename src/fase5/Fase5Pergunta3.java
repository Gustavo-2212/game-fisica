...
public class Fase5Pergunta3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase5Pergunta3 frame = new Fase5Pergunta3(pont);
	...
	public Fase5Pergunta3(Pontuacao p) {
	...
	public void criaComponente() {
		...
		lblE.setBounds(220, 388, 257, 29);
		contentPane.add(lblE);

		txtPerg1 = new JTextArea(teste[0][0]);
		txtPerg1.setBounds(90, 57, 470, 70);
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(3, 5);
	}
