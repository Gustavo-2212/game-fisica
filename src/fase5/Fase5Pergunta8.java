...
public class Fase5Pergunta8 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase5Pergunta8 frame = new Fase5Pergunta8(pont);
	...
	public Fase5Pergunta8(Pontuacao p) {
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(8, 5);
	}
