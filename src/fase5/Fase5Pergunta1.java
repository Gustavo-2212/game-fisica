...
public class Fase5Pergunta1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase5Pergunta1 frame = new Fase5Pergunta1(pont);
	...
	public Fase5Pergunta1(Pontuacao p) {
	...
	public void criaComponente() {
		...
		txtPerg1.setBounds(120, 60, 460, 70);
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(1, 5);
	}
