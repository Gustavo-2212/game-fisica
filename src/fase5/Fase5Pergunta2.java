...
public class Fase5Pergunta2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase5Pergunta2 frame = new Fase5Pergunta2(pont);
	...
	public Fase5Pergunta2(Pontuacao p) {
	...
	public void criaComponente() {
		...
		lblA.setBounds(210, 161, 267, 29);
		contentPane.add(lblA);

		lblB = new JLabel("  " + teste[0][2]);
		lblB.setBounds(210, 215, 267, 29);
		contentPane.add(lblB);

		lblC = new JLabel("  " + teste[0][3]);
		lblC.setBounds(210, 268, 267, 29);
		contentPane.add(lblC);

		lblD = new JLabel("  " + teste[0][4]);
		lblD.setBounds(210, 326, 267, 29);
		contentPane.add(lblD);

		lblE = new JLabel("  " + teste[0][5]);
		lblE.setBounds(210, 383, 267, 29);
		contentPane.add(lblE);

		txtPerg1 = new JTextArea(teste[0][0]);
		txtPerg1.setBounds(95, 55, 490, 70);
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(2, 5);
	}
