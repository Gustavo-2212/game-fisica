...
public class Fase5Pergunta5 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase5Pergunta5 frame = new Fase5Pergunta5(pont);
	...
	public Fase5Pergunta5(Pontuacao p) {
	...
	public void criaComponente() {
		...
		lblD.setBounds(220, 328, 257, 29);
		contentPane.add(lblD);

		lblE = new JLabel("  " + teste[0][5]);
		lblE.setBounds(220, 381, 257, 29);
		contentPane.add(lblE);

		txtPerg1 = new JTextArea(teste[0][0]);
		txtPerg1.setBounds(90, 67, 470, 70);
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(5, 5);
	}
