...
import fase1.Fase1Pergunta4.Movimento;
import fase2.Fase2;
import iftm.edu.ImgFundo;
import iftm.edu.Instrucoes;

public class Fase1Pergunta5 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase1Pergunta5 frame = new Fase1Pergunta5(pont);
	...
	public Fase1Pergunta5(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 825, 450);
		this.setUndecorated(true);
		this.setLocationRelativeTo(null);
		contentPane = new ImgFundo("5");
	...
	public void criaAcao(){
		lblIntr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase1Perg5");
				inst.setVisible(true);
				Fase1Pergunta5.this.dispose();
			}
		});
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(5, 1);
	}
