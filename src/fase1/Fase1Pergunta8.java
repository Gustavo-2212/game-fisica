...
import fase1.Fase1Pergunta7.Movimento;
import fase2.Fase2;
...
public class Fase1Pergunta8 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase1Pergunta8 frame = new Fase1Pergunta8(pont);
	...
	public Fase1Pergunta8(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 825, 450);
		this.setUndecorated(true);
		this.setLocationRelativeTo(null);
		contentPane = new ImgFundo("8");
	...
	public void componente() {
		...
		txtPerg1.setBounds(165, 51, 473, 84);
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\imgPergunta8.png"));
	...
	public void criaAcao() {
		lblIntr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase1Perg8");
				inst.setVisible(true);
				Fase1Pergunta8.this.dispose();
			}
		});
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(8, 1);
	}
