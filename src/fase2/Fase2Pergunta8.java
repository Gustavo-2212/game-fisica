...
public class Fase2Pergunta8 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase2Pergunta8 frame = new Fase2Pergunta8(pont);
	...
	public Fase2Pergunta8(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 820, 476);
		contentPane = new ImgFundo("18");
	...
	public void criaComponente(){
		...
		txtPerg1.setBounds(278, 24, 488, 110);
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\fase2-8.png"));
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(8, 2);
	}
	...
	public void criaAcao(){
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase2Perg8");
				inst.setVisible(true);
				Fase2Pergunta8.this.dispose();
			}
		});
