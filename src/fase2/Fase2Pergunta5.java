...
public class Fase2Pergunta5 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase2Pergunta5 frame = new Fase2Pergunta5(pont);
	...
	public Fase2Pergunta5(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 820, 476);
		contentPane = new ImgFundo("15");
	...
	public void criaComponente(){
		...
		txtPerg1.setBounds(278, 27, 488, 110);
		...
		lblE.setBounds(407, 370, 336, 29);
		lblE.setFont(new Font("Tahoma", Font.PLAIN, 17));
		contentPane.add(lblE);
		
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\fase2-5.png"));
		label.setBounds(0, 0, 819, 485);
	...
	public void criaAcao(){
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase2Perg5");
				inst.setVisible(true);
				Fase2Pergunta5.this.dispose();
			}
		});
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(5, 2);
	}
}
