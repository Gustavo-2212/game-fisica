...
public class Fase2Pergunta3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase2Pergunta3 frame = new Fase2Pergunta3(pont);
	...
	public Fase2Pergunta3(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 820, 476);
		contentPane = new ImgFundo("13");
	...
	public void criaComponente(){
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\fase2-3.png"));
	...
	public void criaAcao(){
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase2Perg3");
				inst.setVisible(true);
				Fase2Pergunta3.this.dispose();
			}
		});
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(3, 2);
	}
}
