...
public class Fase2Pergunta9 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase2Pergunta9 frame = new Fase2Pergunta9(pont);
	...
	public Fase2Pergunta9(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 820, 476);
		contentPane = new ImgFundo("19");
	...
	public void criaComponente(){
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\fase2-9.png"));
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(9, 2);
	}
	...
	public void criaAcao(){
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase2Perg9");
				inst.setVisible(true);
				Fase2Pergunta9.this.dispose();
			}
		});
