...
public class Fase2Pergunta2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase2Pergunta2 frame = new Fase2Pergunta2(pont);
	...
	public Fase2Pergunta2(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 820, 476);
		contentPane = new ImgFundo("12");
	...
	public void criaComponente(){
		...
		txtPerg1.setBounds(278, 23, 488, 110);
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\fase2-2.png"));
	...
	public void criaAcao(){
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase2Perg2");
				inst.setVisible(true);
				Fase2Pergunta2.this.dispose();
			}
		});
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(2, 2);
	}
}
