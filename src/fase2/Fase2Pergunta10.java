...
public class Fase2Pergunta10 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase2Pergunta10 frame = new Fase2Pergunta10(pont);
	...
	public Fase2Pergunta10(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 820, 476);
		contentPane = new ImgFundo("20");
	...
	public void criaComponente(){
		...
		txtPerg1.setBounds(277, 23, 488, 110);
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\fase2-10.png"));
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(10, 2);
	}
	...
	public void criaAcao(){
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase2Perg10");
				inst.setVisible(true);
				Fase2Pergunta10.this.dispose();
			}
		});
