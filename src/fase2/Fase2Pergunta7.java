...
public class Fase2Pergunta7 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase2Pergunta7 frame = new Fase2Pergunta7(pont);
	...
	public Fase2Pergunta7(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 820, 476);
		contentPane = new ImgFundo("17");
	...
	public void criaComponente(){
		...
		txtPerg1.setBounds(278, 26, 488, 110);
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\fase2-7.png"));
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(7, 2);
	}
	...
	public void criaAcao(){
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase2Perg7");
				inst.setVisible(true);
				Fase2Pergunta7.this.dispose();
			}
		});
