...
public class Fase2Pergunta1 extends JFrame {

	private static Pontuacao pont;
	private JPanel contentPane;
	private JTextArea txtPerg1;
	private JLabel lblA, lblB, lblC, lblD, lblE, lblVoltar;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase2Pergunta1 frame = new Fase2Pergunta1(pont);
	...
	public Fase2Pergunta1(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 820, 476);
		contentPane = new ImgFundo("11");
	...
	public void criaComponente(){
		...
		txtPerg1.setBounds(278, 29, 488, 110);
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\fase2-1.png"));
		label.setBounds(0, 0, 822, 485);
	...
	public void criaAcao(){
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase2Perg1");
				inst.setVisible(true);
				Fase2Pergunta1.this.dispose();
			}
		});
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(1, 2);
