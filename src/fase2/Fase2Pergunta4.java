...
public class Fase2Pergunta4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase2Pergunta4 frame = new Fase2Pergunta4(pont);
	...
	public Fase2Pergunta4(Pontuacao p) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 820, 476);
		contentPane = new ImgFundo("14");
	...
	public void criaComponente(){
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("imgs\\fase2-4.png"));
	...
	public void criaAcao(){
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase2Perg4");
				inst.setVisible(true);
				Fase2Pergunta4.this.dispose();
			}
		});
	...
	public void carregaQuestao(){
		...
		teste = perg.carregaPergunta(4, 2);
	}
}