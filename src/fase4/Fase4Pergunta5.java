...
public class Fase4Pergunta5 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase4Pergunta5 frame = new Fase4Pergunta5(pont);
	...
	public Fase4Pergunta5(Pontuacao p) {
	...
	public void criaComponente() {
		...
		lblA.setBounds(183, 179, 221, 31);
		contentPane.add(lblA);

		lblB = new JLabel("  " + teste[0][2]);
		lblB.setBounds(183, 231, 221, 31);
		contentPane.add(lblB);

		lblC = new JLabel("  " + teste[0][3]);
		lblC.setBounds(183, 281, 221, 31);
		contentPane.add(lblC);

		lblD = new JLabel("  " + teste[0][4]);
		lblD.setBounds(183, 331, 221, 31);
		contentPane.add(lblD);

		lblE = new JLabel("  " + teste[0][5]);
		lblE.setBounds(183, 381, 221, 31);
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(5, 4);
	}
