...
public class Fase4Pergunta8 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase4Pergunta8 frame = new Fase4Pergunta8(pont);
	...
	public Fase4Pergunta8(Pontuacao p) {
	...
	public void criaComponente() {
		...
		lblA.setBounds(183, 180, 221, 30);
		contentPane.add(lblA);

		lblB = new JLabel("  " + teste[0][2]);
		lblB.setBounds(183, 232, 221, 30);
		contentPane.add(lblB);

		lblC = new JLabel("  " + teste[0][3]);
		lblC.setBounds(183, 282, 221, 30);
		contentPane.add(lblC);

		lblD = new JLabel("  " + teste[0][4]);
		lblD.setBounds(183, 330, 221, 30);
		contentPane.add(lblD);

		lblE = new JLabel("  " + teste[0][5]);
		lblE.setBounds(183, 382, 221, 30);
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(8, 4);
	}
