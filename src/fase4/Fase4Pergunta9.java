...
public class Fase4Pergunta9 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase4Pergunta9 frame = new Fase4Pergunta9(pont);
	...
	public Fase4Pergunta9(Pontuacao p) {
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(9, 4);
	}
