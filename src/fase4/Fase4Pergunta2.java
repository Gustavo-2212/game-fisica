...
public class Fase4Pergunta2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase4Pergunta2 frame = new Fase4Pergunta2(pont);
	...
	public Fase4Pergunta2(Pontuacao p) {
	...
	public void criaComponente() {
		...
		txtPerg1.setBounds(60, 60, 490, 90);
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(2, 4);
	}
