...
public class Fase4Pergunta3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase4Pergunta3 frame = new Fase4Pergunta3(pont);
	...
	public Fase4Pergunta3(Pontuacao p) {
	...
	public void criaComponente() {
		...
		lblA.setBounds(183, 181, 221, 29);
		contentPane.add(lblA);

		lblB = new JLabel("  " + teste[0][2]);
		lblB.setBounds(183, 233, 221, 29);
		contentPane.add(lblB);

		lblC = new JLabel("  " + teste[0][3]);
		lblC.setBounds(183, 283, 221, 29);
		contentPane.add(lblC);

		lblD = new JLabel("  " + teste[0][4]);
		lblD.setBounds(183, 333, 221, 29);
		contentPane.add(lblD);

		lblE = new JLabel("  " + teste[0][5]);
		lblE.setBounds(183, 383, 221, 29);
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(3, 4);
	}
