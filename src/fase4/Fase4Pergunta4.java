...
public class Fase4Pergunta4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase4Pergunta4 frame = new Fase4Pergunta4(pont);
	...
	public Fase4Pergunta4(Pontuacao p) {
	...
	public void criaComponente() {
		...
		txtPerg1.setBounds(67, 70, 476, 60);
		...
		txtPerg1.setFont(new Font("Times New Roman", Font.BOLD, 16));
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(4, 4);
	}
