...
public class Fase4Pergunta7 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase4Pergunta7 frame = new Fase4Pergunta7(pont);
	...
	public Fase4Pergunta7(Pontuacao p) {
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(7, 4);
	}
