...
public class Fase4Pergunta6 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase4Pergunta6 frame = new Fase4Pergunta6(pont);
	...
	public Fase4Pergunta6(Pontuacao p) {
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(6, 4);
	}
