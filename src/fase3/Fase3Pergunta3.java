...
public class Fase3Pergunta3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase3Pergunta3 frame = new Fase3Pergunta3(pont);
	...
	public Fase3Pergunta3(Pontuacao p) {
	...
	public void criaAcao() {
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase3Perg3");
				inst.setVisible(true);
				Fase3Pergunta3.this.dispose();
			}
		});
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(3, 3);
	}
