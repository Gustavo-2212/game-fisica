...
public class Fase3Pergunta2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase3Pergunta2 frame = new Fase3Pergunta2(pont);
	...
	public Fase3Pergunta2(Pontuacao p) {
	...
	public void criaAcao() {
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase3Perg2");
				inst.setVisible(true);
				Fase3Pergunta2.this.dispose();
			}
		});
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(2, 3);
	}
