...
public class Fase3Pergunta7 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase3Pergunta7 frame = new Fase3Pergunta7(pont);
	...
	public Fase3Pergunta7(Pontuacao p) {
	...
	public void criaComponente() {
		...
		txtPerg1.setBounds(76, 26, 489, 87);
	...
	public void criaAcao() {
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase3Perg7");
				inst.setVisible(true);
				Fase3Pergunta7.this.dispose();
			}
		});
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(7, 3);
	}
