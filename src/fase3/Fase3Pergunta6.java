...
public class Fase3Pergunta6 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase3Pergunta6 frame = new Fase3Pergunta6(pont);
	...
	public Fase3Pergunta6(Pontuacao p) {
	...
	public void criaComponente() {
		...
		txtPerg1.setBounds(76, 26, 489, 90);
	...
	public void criaAcao() {
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase3Perg6");
				inst.setVisible(true);
				Fase3Pergunta6.this.dispose();
			}
		});
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(6, 3);
	}
