...
public class Fase3Pergunta4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase3Pergunta4 frame = new Fase3Pergunta4(pont);
	...
	public Fase3Pergunta4(Pontuacao p) {
	...
	public void criaAcao() {
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase3Perg4");
				inst.setVisible(true);
				Fase3Pergunta4.this.dispose();
			}
		});
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(4, 3);
	}
