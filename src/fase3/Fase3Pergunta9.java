...
public class Fase3Pergunta9 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase3Pergunta9 frame = new Fase3Pergunta9(pont);
	...
	public Fase3Pergunta9(Pontuacao p) {
	...
	public void criaAcao() {
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase3Perg9");
				inst.setVisible(true);
				Fase3Pergunta9.this.dispose();
			}
		});
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(9, 3);
	}
