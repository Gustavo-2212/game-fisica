...
public class Fase3Pergunta8 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Fase3Pergunta8 frame = new Fase3Pergunta8(pont);
	...
	public Fase3Pergunta8(Pontuacao p) {
	...
	public void criaComponente() {
		...
		txtPerg1.setBounds(76, 26, 489, 105);
	...
	public void criaAcao() {
		lblInstr.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Instrucoes inst = new Instrucoes(pont, "fase3Perg8");
				inst.setVisible(true);
				Fase3Pergunta8.this.dispose();
			}
		});
	...
	public void carregaQuestao() {
		...
		teste = perg.carregaPergunta(8, 3);
	}
